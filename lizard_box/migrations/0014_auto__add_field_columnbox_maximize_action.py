...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ColumnBox.maximize_action'
        db.add_column('lizard_box_columnbox', 'maximize_action', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ColumnBox.maximize_action'
        db.delete_column('lizard_box_columnbox', 'maximize_action')
