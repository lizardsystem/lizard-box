...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ColumnBox.height'
        db.add_column('lizard_box_columnbox', 'height', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ColumnBox.height'
        db.delete_column('lizard_box_columnbox', 'height')
