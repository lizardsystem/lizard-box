...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ColumnBox.name'
        db.add_column('lizard_box_columnbox', 'name', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ColumnBox.name'
        db.delete_column('lizard_box_columnbox', 'name')
