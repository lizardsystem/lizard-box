...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ColumnBox.refresh_millis'
        db.add_column('lizard_box_columnbox', 'refresh_millis', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ColumnBox.refresh_millis'
        db.delete_column('lizard_box_columnbox', 'refresh_millis')
