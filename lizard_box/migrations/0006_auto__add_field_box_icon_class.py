...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Box.icon_class'
        db.add_column('lizard_box_box', 'icon_class', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Box.icon_class'
        db.delete_column('lizard_box_box', 'icon_class')
