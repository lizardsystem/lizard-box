...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PortalTab.name'
        db.add_column('lizard_box_portaltab', 'name', self.gf('django.db.models.fields.CharField')(default='test', max_length=40), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PortalTab.name'
        db.delete_column('lizard_box_portaltab', 'name')
