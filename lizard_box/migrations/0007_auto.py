...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field action_boxes on 'ColumnBox'
        db.create_table('lizard_box_columnbox_action_boxes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('columnbox', models.ForeignKey(orm['lizard_box.columnbox'], null=False)),
            ('box', models.ForeignKey(orm['lizard_box.box'], null=False))
        ))
        db.create_unique('lizard_box_columnbox_action_boxes', ['columnbox_id', 'box_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field action_boxes on 'ColumnBox'
        db.delete_table('lizard_box_columnbox_action_boxes')
