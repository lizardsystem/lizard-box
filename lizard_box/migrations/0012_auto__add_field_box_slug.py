...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Box.slug'
        db.add_column('lizard_box_box', 'slug', self.gf('django.db.models.fields.SlugField')(default='home', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Box.slug'
        db.delete_column('lizard_box_box', 'slug')
